...
def present(duration=150):
    ...
    targets = list(map(load_image, glob(
        'stimulus_presentation/stim_b2/Positive_neutral/Target/*.bmp')))
    distractors = list(map(load_image, glob(
        'stimulus_presentation/stim_b2/Positive_neutral/Distractor/*.bmp')))
...
def main():
    ...
    parser.add_option("-d", "--duration",
                      dest="duration", type='int', default=150,
